// ==UserScript==
// @name         [Optimus] E2E French Auto Compare Metadata across locales
    ...
    setTimeout(function(){
        ...
        function checkDuplicateItem(descriptionPageInfo, typeOfItem, nameShow){
            ...
            for (var index in uniqueDescription){
                ...
                for (locale in descriptionPageInfo){
                    ...
                    if (uniqueDescription[index] === metaDataFormatted && locale.indexOf("fr-") >= 0){
        ...
        function checkDuplicateImage(mediaInfo){
            ...
            for (var locale in mediaInfo){
                if (mediaInfo[locale].locale.indexOf("fr_") >= 0 && mediaInfo[locale].assetType == "icon"){
            ...
            for (var index in uniqueIcon){
                ...
                for (locale in mediaInfo){
                    ...
                    if (getBase64Image(uniqueIcon[index])
                        === getBase64Image(metaDataFormatted) && mediaInfo[locale].locale.indexOf("fr_")
